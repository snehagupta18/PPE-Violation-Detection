...
def create_message(sender, to, subject, message_text, img_file):
    ...
    formatted_date_time = time.strftime("%H_%M_%S_%d-%m-%Y", time.localtime(current_date_time))
...
if __name__ == '__main__':
    ...
    '''prepare_and_send_email(sender='sneha2021csds137@abesit.edu.in', 
                           recipient='snehaguptaa1812@gmail.com',
